...
void button_ctrl_init(Controls *c, Master *m)
{
    ...
    c->arr[PERSON] = (Button){img_init(800, 200, "../sprites/person.png", m, false), IMG_LoadTexture(m->renderer, "../sprites/history_A.png"), false};
    c->arr[ROBOT] = (Button){img_init(1000, 200, "../sprites/robot.png", m, false), IMG_LoadTexture(m->renderer, "../sprites/history_A.png"), false};
    c->arr[B_BLACK] = (Button){img_init(800, 200, "../sprites/disk_B.png", m, false), IMG_LoadTexture(m->renderer, "../sprites/history_A.png"), false};
    c->arr[B_WHITE] = (Button){img_init(1000, 200, "../sprites/disk_W.png", m, false), IMG_LoadTexture(m->renderer, "../sprites/history_A.png"), false};
    c->size = SIZE;
}
